...
contract TimelockController is AccessControl {
     ...
     * Value, in wei, that should be sent with the transaction.
     * Most of the time this will be 0. Ether can be deposited before-end or passed along when executing the transaction.
     */
    function schedule(
        address target,
        uint256 value,
